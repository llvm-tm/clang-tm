...
\begin{tabular}{M{0.15\linewidth}M{0.19\linewidth}M{0.23\linewidth}M{0.31\linewidth}}
\hline
\thb{0.15\textwidth}{Backend} & \thb{0.19\textwidth}{Workload slice} & \thb{0.23\textwidth}{Throughput} & \thb{0.31\textwidth}{Modeling use} \\
\hline
...
\begin{tabular}{M{0.28\linewidth}M{0.34\linewidth}M{0.30\linewidth}}
\hline
\thb{0.28\textwidth}{Symptom} & \thb{0.34\textwidth}{Likely cause} & \thb{0.30\textwidth}{First check} \\
\hline
...
\section[Model Checking a Bounded Contention Counter]{Worked Example: Model Checking a Bounded Contention Counter}
