...
\begin{table}[htbp]
\centering
 \begin{tabular}{|M{0.22\linewidth}|M{0.24\linewidth}|M{0.22\linewidth}|M{0.22\linewidth}|}
\hline
\thb{0.22\textwidth}{\textbf{Operation}} & \thb{0.24\textwidth}{\textbf{When executed}} & \thb{0.22\textwidth}{\textbf{Abort action}} & \thb{0.22\textwidth}{\textbf{Commit action}} \\
\hline
