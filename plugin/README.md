...
# Specify runtime by path or bare name (looked up in backends/tm_impl/)
clang-tm --runtime SingleGlobalLock_runtime.cpp -o myapp app.cpp
clang-tm --runtime ../backends/tm_impl/tl2/tl2_runtime.cpp -o myapp app.cpp
```
...
make -C benchmarks/plugin/bank \
    TM_PLUGIN=../../plugin/bin/libTMInstrument_no_setjmp.so \
    bank_singlelock
```
