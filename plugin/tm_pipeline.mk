...
#   DEBUG             — tm-instrument, -O0, -O0 -g link (see docs/plugin-debug.md)
#
...
TM_COMPILE_FLAGS ?= -O1 -fno-inline -fno-vectorize -fno-slp-vectorize \
                    ...
                    -I$(BACKENDS_DIR)/tm_impl/common -I$(BACKENDS_DIR)/tm_impl/tiny_stm -I$(BACKENDS_DIR) \
                    -I$(LLVM_PLUGIN_DIR)/../benchmarks/plugin/datastructures
...
SWISSTM_DIR      ?= $(BACKENDS_DIR)/tm_impl/swisstm
...
TM_RUNTIME_tl2          = $(RUNTIMES_DIR)/tl2/tl2_runtime.cpp
TM_RUNTIME_singlelock   = $(RUNTIMES_DIR)/single_global_lock/SingleGlobalLock_runtime.cpp
TM_RUNTIME_swisstm      = $(RUNTIMES_DIR)/swisstm/SwissTM_runtime.cpp
TM_RUNTIME_norec        = $(RUNTIMES_DIR)/norec/NOrec_runtime.cpp
TM_RUNTIME_persistentsgl = $(RUNTIMES_DIR)/persistent_sgl/PersistentSGL_runtime.cpp
TM_RUNTIME_distributedsgl = $(RUNTIMES_DIR)/distributed_sgl/DistributedSGL_runtime.cpp
TM_RUNTIME_tsxsgl        = $(RUNTIMES_DIR)/tsx_sgl/TSXSGL_runtime.cpp
TM_RUNTIME_tinystm_wbctl = $(RUNTIMES_DIR)/tiny_stm/TinySTM_runtime.cpp
TM_RUNTIME_tinystm_wbetl = $(RUNTIMES_DIR)/tiny_stm/TinySTM_runtime.cpp
