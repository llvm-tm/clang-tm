...
TM bool contains(int value) { return find(value) >= 0; }

TM bool insert(int value)
{
	if (set_size >= MAX_NODES)
		return false;
	if (contains(value))
		return false;
...
TM int size() { return set_size; }

TX bool txn_insert(int value) { return insert(value); }

TX bool txn_remove(int value) { return remove(value); }

TX bool txn_contains(int value) { return contains(value); }
