...
TX static bool add_reservation(RBTree<long, ReservationData> *table,
                               long id,
                               long num,
                               long price)
{
...
TX static bool delete_reservation(RBTree<long, ReservationData> *table, long id, long num)
{
	ReservationData *r = reservation_find(table, id);
	if (!r || r->numTotal == 0)
		return false;
