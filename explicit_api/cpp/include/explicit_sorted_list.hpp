...
template <bool UseTM, typename T> bool insert(List<T> *list, Node<T> *node)
{
...
// ── remove ─────────────────────────────────────────────────────────
template <bool UseTM, typename T> bool remove(List<T> *list, const T &data)
{
	using MA = MemoryAccess<UseTM>;
	Node<T> *prev = nullptr;
	Node<T> *curr = MA::load(&list->head);
...
// ── contains ───────────────────────────────────────────────────────
template <bool UseTM, typename T> bool contains(List<T> *list, const T &data)
{
	using MA = MemoryAccess<UseTM>;
	Node<T> *curr = MA::load(&list->head);
	while (curr) {
