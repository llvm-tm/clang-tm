...
template <typename K, typename V> struct Tree {
	Node<K, V> *root = nullptr;
};

// ── lookup ──────────────────────────────────────────────────────────
template <bool UseTM, typename K, typename V> Node<K, V> *lookup(Tree<K, V> *tree, K key)
{
...
// ── find ────────────────────────────────────────────────────────────
template <bool UseTM, typename K, typename V> V *find(Tree<K, V> *tree, K key)
{
...
// ── contains ────────────────────────────────────────────────────────
template <bool UseTM, typename K, typename V> bool contains(Tree<K, V> *tree, K key)
{
