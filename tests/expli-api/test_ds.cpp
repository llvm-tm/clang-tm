...
#include "expli_tm_api/tm_map.hpp"
#include <cstdio>
#include <cstring>
...
static void test_vector()
{
	...
	// element access
	for (int i = 0; i < 100; i++)
		CHECK(v[i] == i, "vector element access");
	...
	for (int i = 50; i < 100; i++)
		CHECK(v[i] == 0, "vector resize default");
...
int main()
{
	...
	printf("  my::pair:       %s\n", failures ? "FAIL" : "PASS");
	test_vector();
	printf("  my::vector<int>: %s\n", failures ? "FAIL" : "PASS");
	test_vector_string();
	printf("  my::vector<string>: %s\n", failures ? "FAIL" : "PASS");
	test_flat_map();
	printf("  flat_map:       %s\n", failures ? "FAIL" : "PASS");
	test_flat_multimap();
	printf("  flat_multimap:  %s\n", failures ? "FAIL" : "PASS");
	test_flat_set();
	printf("  flat_set:       %s\n", failures ? "FAIL" : "PASS");
	test_tm_peek_poke();
	printf("  TM<int> peek:   %s\n", failures ? "FAIL" : "PASS");
	test_tm_pair_composition();
	printf("  TM composition: %s\n", failures ? "FAIL" : "PASS");
