...
TX void tx_insert(int32_t key, int32_t val)
{
	...
	while (g_nodes[z].parent >= 0 && g_nodes[g_nodes[z].parent].color == RED) {
...
TX int32_t tx_count() { return g_count; }
