"""
Restore variant of the classic-memory (Ruby-free) config — resumes a checkpoint saved by x86-se-bank-checkpoint-classic.py — bypasses Ruby/MESI_Three_Level_HTM
...
KNOWN LIMITATION (2026-09-01): restore hangs in SE mode for the
multithreaded pthread benchmark (process/FD state not fully serialized —
pre-existing gem5 SE checkpoint caveat).  The classic save path works; a
full save→restore round-trip is not yet stable.
"""
