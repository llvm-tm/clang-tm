...
impl BackendProfile {
    pub fn from_name(name: &str) -> Self {
        match name {
            ...
            "mvlog" => BackendProfile::Mvlog,
            "tsc-tm" | "tsc_tm" => BackendProfile::TscTm,
    ...
    pub fn machine_profile_name(&self) -> &'static str {
        match self {
            ...
            BackendProfile::Mvlog => "mvlog",
            // TSC-TM is a TL2 variant: reuse the TL2 machine profile.
            BackendProfile::TscTm => "tl2",
