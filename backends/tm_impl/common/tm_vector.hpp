...
extern "C" void tm_debug_grow(void *this_ptr,
                              size_t m_cap,
                              size_t m_size,
                              size_t nc,
                              size_t min_cap,
...
template <typename T> class TMSafeVector
{
	T *m_data;
	size_t m_size;
	size_t m_cap;
...
public:
	...
	TMSafeVector(std::initializer_list<T> il)
	    : m_data(nullptr),
	      m_size(0),
	      m_cap(0)
	{
	...
	explicit TMSafeVector(size_t n)
	    : m_data(nullptr),
	      m_size(0),
	      m_cap(0)
	{
	...
	TMSafeVector(size_t n, const T &val)
	    : m_data(nullptr),
	      m_size(0),
	      m_cap(0)
	{
	...
	TMSafeVector(const TMSafeVector &o)
	    : m_data(nullptr),
	      m_size(0),
	      m_cap(0)
	{
