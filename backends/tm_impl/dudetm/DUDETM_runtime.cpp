...
static void push_alloc_entry(void *ptr, size_t size)
{
...
static void push_free_entry(void *ptr)
{
	dudetm::DUDERedoEntry e;
...
static void real_tm_end()
{
	...
	uint64_t seq = dudetm::g_ctrl->global_commit_seq
