...
static uint16_t real_tm_read_i2(uint16_t *addr) { return mvlog::tm_read_i2(addr); }

static uint32_t real_tm_read_i4(uint32_t *addr) { return mvlog::tm_read_i4(addr); }

static uint64_t real_tm_read_i8(uint64_t *addr) { return mvlog::tm_read_i8(addr); }
...
static void *real_tm_read_ptr(void **addr) { return mvlog::tm_read_ptr(addr); }
...
static void real_tm_write_f4(float *addr, float val) { mvlog::tm_write_f4(addr, val); }

static void real_tm_write_f8(double *addr, double val) { mvlog::tm_write_f8(addr, val); }

static void real_tm_write_ptr(void **addr, void *val) { mvlog::tm_write_ptr(addr, val); }
