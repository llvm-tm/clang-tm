...
void*     tm_read_ptr(void **addr, uint32_t symbol_id)    { (void)symbol_id; return tinystm::tm_read_ptr(addr); }
...
void tm_write_ptr(void **addr, void *val, uint32_t symbol_id)        { (void)symbol_id; tinystm::tm_write_ptr(addr, val); }
