...
inline void* operator new(size_t size)                     { return tm_malloc(size); }
inline void* operator new(size_t size, std::nothrow_t const&) noexcept { return tm_malloc(size); }
inline void* operator new[](size_t size)                   { return tm_malloc(size); }
inline void* operator new[](size_t size, std::nothrow_t const&) noexcept { return tm_malloc(size); }
...
inline void* operator new(size_t size, std::align_val_t align, std::nothrow_t const&) noexcept {
...
inline void operator delete(void* ptr) noexcept                        { tm_free(ptr); }
inline void operator delete(void* ptr, std::nothrow_t const&) noexcept { tm_free(ptr); }
inline void operator delete[](void* ptr) noexcept                      { tm_free(ptr); }
inline void operator delete[](void* ptr, std::nothrow_t const&) noexcept { tm_free(ptr); }

// Sized delete (C++14)
inline void operator delete(void* ptr, size_t) noexcept   { tm_free(ptr); }
inline void operator delete[](void* ptr, size_t) noexcept { tm_free(ptr); }

// Aligned delete (C++17)
inline void operator delete(void* ptr, std::align_val_t) noexcept                  { tm_free(ptr); }
inline void operator delete(void* ptr, std::align_val_t, std::nothrow_t const&) noexcept { tm_free(ptr); }
inline void operator delete[](void* ptr, std::align_val_t) noexcept                { tm_free(ptr); }
inline void operator delete[](void* ptr, std::align_val_t, std::nothrow_t const&) noexcept { tm_free(ptr); }
inline void operator delete(void* ptr, size_t, std::align_val_t) noexcept          { tm_free(ptr); }
inline void operator delete[](void* ptr, size_t, std::align_val_t) noexcept        { tm_free(ptr); }
